...
ActiveRecord::Schema[8.0].define(version: 2025_11_15_090001) do
  ...
  create_table "conversations", force: :cascade do |t|
    ...
    t.datetime "latest_message_at", precision: nil
    t.datetime "latest_incoming_message_at", precision: nil
    t.boolean "intervention_enabled", default: false, null: false
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
  ...
  create_table "products", force: :cascade do |t|
    ...
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["chatbot_id"], name: "index_products_on_chatbot_id"
  end
  ...
  create_table "wabas", force: :cascade do |t|
    ...
    t.index ["chatbot_id"], name: "index_wabas_on_chatbot_id"
  end
  ...
  add_foreign_key "products", "chatbots"
